...
#    cla_agree: "I AGREE"
  ...
  login:
    ...
    or: ", hay "
    recover: "tìm lại tài khoản"

  recover:
    recover_account_title: "tìm lại tài khoản"
#    send_password: "Send Recovery Password"

  signup:
#    create_account_title: "Create Account to Save Progress"
    description: "Game này miễn phí. Thêm 1 chút nữa thôi là xong:"
    email_announcements: "Nhận thông báo qua email"
    coppa: "Trên 13 tuổi hay ở ngoài nước Mỹ "
    coppa_why: "(Tai sao?))"
  ...
  home:
    slogan: "Học lập trình Javascript bằng cách Chơi game"
    no_ie: "CodeCombat không chạy được trên IE8 hay cũ hơn. Xin lỗi!"
    no_mobile: "CodeCombat không đuợc thiết kế cho thiết bị di động và có thể không chạy được!"
    play: "Chơi"

  play:
    choose_your_level: "Chọn trình độ chơi"
    adventurer_prefix: "Bạn có thể chọn trình chơi sau đây "
...
#    campaign_player_created_description: "... in which you battle against the creativity of your fellow <a href=\"/contribute#artisan\">Artisan Wizards</a>."
    level_difficulty: "Mức độ khó: "

  contact:
    contact_us: "Liên hệ CodeCombat"
    welcome: "Rất vui được nhận tin từ bạn! Hãy dùng mẫu đơn này để gởi mail cho chúng tôi "
...
#    title: "Help translate CodeCombat!"
    ...
    pitch_body: "Chúng tôi phát triển CodeCombat bằng Tiếng Anh, nhưng chúng tôi có tất cả các người chơi trên toàn thế giới. Đa phần đều chơi trong chế độ Tiếng Anh, dù họ không nói tiếng anh. Vì thế nếu bạn có thể nói được 2 thứ tiếng trở lên, hãy đăng ký để làm Người phiên dịch và giúp chúng tôi dịch thuật trang web CodeCombat từ tiếng anh sang các thứ tiếng bạn biết và ngược lại."
#    missing_translations: "Until we can translate everything into Vietnamese, you'll see English when Vietnamese isn't available."
    learn_more: "Tìm hiểu thêm về đăng ký làm Người phiên dịch"
...
#    customize_avatar: "Customize Your Avatar"
  ...
  account_settings:
    ...
    autosave: "Thay đổi được tự động lưu lại"
#    me_tab: "Me"
    picture_tab: "Hình ảnh"
#    wizard_tab: "Wizard"
...
#    email_toggle: "Toggle All"
    saving: "Lưu..."
    error_saving: "Lỗi khi lưu"
    saved: "Thay đổi đã được lưu"
...
#    gravatar_not_found_other: "Alas, there's no profile associated with this person's email address."
    gravatar_contact: "Liên hệ"
    gravatar_websites: "Trang web"
#    gravatar_accounts: "As Seen On"
#    gravatar_profile_link: "Full Gravatar Profile"

  play_level:
    level_load_error: "Trình chơi không tải được"
    done: "Hoàn tất"
#    grid: "Grid"
...
#    action_timeline: "Action Timeline"
    click_to_select: "Nhấp chuột để chọn đơn vị"
#    reload_title: "Reload All Code?"
#    reload_really: "Are you sure you want to reload this level back to the beginning?"
    reload_confirm: "Tải lại toàn bộ"
#    victory_title_prefix: ""
#    victory_title_suffix: " Complete"
#    victory_sign_up: "Sign Up to Save Progress"
#    victory_sign_up_poke: "Want to save your code? Create a free account!"
    victory_rate_the_level: "Xếp hạng trình chơi "
    victory_play_next_level: "Chơi trình kế tiếp"
    victory_go_home: "Về lại Trang chủ"
#    victory_review: "Tell us more!"
#    victory_hour_of_code_done: "Are You Done?"
#    victory_hour_of_code_done_yes: "Yes, I'm finished with my Hour of Code!"
    multiplayer_title: "Cài đặt Nhiều người chơi"
    multiplayer_link_description: "Gởi link đến bất kỳ ai để tham gia cùng bạn"
    multiplayer_hint_label: "Gợi ý"
...
#    tome_autocast_delay: "Autocast Delay"
    tome_autocast_1: "1 giây"
    tome_autocast_3: "3 giây"
    tome_autocast_5: "5 giây"
    tome_autocast_manual: "Thủ công"
    tome_select_spell: "Chọn bùa chú"
