...
#    cla_agree: "I AGREE"
  ...
  recover:
    recover_account_title: "שחזר חשבון"
#    send_password: "Send Recovery Password"

  signup:
#    create_account_title: "Create Account to Save Progress"
    description: "זה בחינם. רק כמה דברים ותוכל להתחיל:"
    email_announcements: "קבל התארות במייל"
    coppa: "גילאי 13+ או מחוץ לארה"ב""
    coppa_why: "(למה?)"
    creating: "יוצר חשבון..."
    sign_up: "הירשם"
    or: "או "
    log_in: "היכנס באמצעות סיסמה"

  home:
    slogan: "למד לתכנת Javascript ע"י מש"חק"
    no_ie: "CodeCombat לא עובד ב-IE8 ודפדפנים ישנים יותר. מצטערים!"
    no_mobile: "CodeCombat לא תוכנן לעבוד על מכשירים ניידים ועלול לא לעבוד!"
    play: "שחק"

  play:
    choose_your_level: "בחר שלב"
    adventurer_prefix: "אתה יכול לבחור בכל אחד מהשלבים למטה, או לדבר על שלבים "
    adventurer_forum: "בפורום ההרפתקנים"
    adventurer_suffix: "."
    campaign_beginner: "מסלול למתחילים"
    campaign_beginner_description: "...כאן תלמד את הקוסמות של תכנות."
    campaign_dev: "שלבים קשים יותר"
    campaign_dev_description: "...כאן תלמד את הממשק בזמן שאתה עושה דברים קשים יותר."
    campaign_multiplayer: "סביבות מרובות משתתפים"
    campaign_multiplayer_description: "כאן תוכל לתכנת ראש-בראש מול שחקנים אחרים."
#    campaign_player_created: "Player-Created"
 #   campaign_player_created_description: "... in which you battle against the creativity of your fellow <a href=\"/contribute#artisan\">Artisan Wizards</a>."
    level_difficulty: "רמת קושי: "

  contact:
    contact_us: "צור קשר עם CodeCombat"
    welcome: "טוב לשמוע ממך! השתמש בטופס הזה כדי לשלוח לנו אי-מייל. "
...
#    send: "Send Feedback"
  ...
  diplomat_suggestion:
    ...
    sub_heading: "אנחנו צריכים את כישורי התרגום שלך."
...
#    gravatar_profile_link: "Full Gravatar Profile"
  ...
  play_level:
    level_load_error: "השלב לא הצליח להיטען."
#    done: "Done"
    grid: "גריד"
    customize_wizard: "ערוך את הקוסם"
    home: "בית"
    guide: "מדריך"
    multiplayer: "ריבוי משתתפים"
    restart: "התחל מחדש"
    goals: "יעדים"
#    action_timeline: "Action Timeline"
    click_to_select: "לחץ על דמות כדי לבחור אותה"
    reload_title: "טען מחדש את הקוד?"
    reload_really: "האם אתה בטוח שברצונך לאתחל את השלב?"
    reload_confirm: "אתחל הכל"
    victory_title_prefix: ""
    victory_title_suffix: " הושלם"
    victory_sign_up: "הירשם לעדכונים"
#    victory_sign_up_poke: "Want to save your code? Create a free account!"
    victory_rate_the_level: "דרג את השלב: "
    victory_play_next_level: "שחק בשלב הבא"
    victory_go_home: "הביתה"
    victory_review: "ספר לנו עוד!"
    victory_hour_of_code_done: "Aהאם סיימת?"
    victory_hour_of_code_done_yes: "כן, סיימתי את שעת הקוד שלי!"
    multiplayer_title: "הגדרות ריבוי משתמשים"
