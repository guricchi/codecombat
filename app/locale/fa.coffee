...
#    cla_url: "CLA"
  ...
  play:
    choose_your_level: "سطح خود را انتخاب کنید"
    adventurer_prefix: "می‌توانید به هرکدام از مراحل زیر بروید یا درباره‌ی آن‌ها گفت‌وگو کنید "
    adventurer_forum: "در انجمن ماجراجویی"
#    adventurer_suffix: "."
    campaign_beginner: "کمپین تازه‌کاران"
    campaign_beginner_description: "... که در آن جادوگری برنامه‌نویسی را یاد می‌گیرید"
    campaign_dev: "سطوح سخت‌تر تصادفی"
...
#    campaign_player_created_description: "... in which you battle against the creativity of your fellow <a href=\"/contribute#artisan\">Artisan Wizards</a>."
  ...
  contact:
    contact_us: "تماس با CodeCombat"
    welcome: "خوب است که از شما بشنویم! از این فرم استفاده کنید و برای ما ایمیل بفرستید. "
    contribute_prefix: "اگر علاقه به همکاری دارید ، سری بزنید به  "
    contribute_page: "صفحه همکاری"
#    contribute_suffix: "!"
    forum_prefix: "برای هرچیز عمومی ، لطفا کمک بگیرید از "
#    forum_page: "انجمن ما."
#    forum_suffix: " در عوض"
#    sending: "در حال ارسال..."
#    send: "ارسال بازخورد"
  ...
  diplomat_suggestion:
#    title: "برای ترجمه CodeCombat کمک کنید!"
#    sub_heading: "ما به مهارت‌های شما در زبان نیاز داریم."
    pitch_body: "ما CodeCombat را به زبان انگلیسی توسعه می‌دهیم ، اما بازیکنان دیگر از سراسر دنیا هم داریم. بسیازی از آنان با زبان {English} بازی میکنند ولی انگلیسی سخن نمی‌گویند. پس اگر شما به هر دو سخن می‌گویید ، لطفا به ثبت‌نام برای دیپلمات بودن رسیدگی کنید و برای ترجمه وبسایت CodeCombatو همه مراحل در {English} کمک کنید. "
...
#    customize_avatar: "Customize Your Avatar"
  ...
  account_settings:
    ...
    not_logged_in: "ورود یا ایجاد حساب کاربری برای تغییرات در تنظیمات شما"
